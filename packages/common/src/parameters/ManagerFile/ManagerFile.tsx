...
import GridListImage from '@pxp-ui/components/GridListImage/GridListImage';
import Pxp from '@pxp-ui/core/Pxp';
import DialogPxp from '@pxp-ui/components/DialogPxp';
import File from '@pxp-ui/core/icons/File';
...
const ManagerFile = ({
  ...
  const refManagerFileTable: any = useRef();
